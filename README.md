...
Det kreves ingen avansert installasjon for å kjøre denne siden lokalt. Prosjektet er bygget med HTML, CSS og JavaScript, og krever kun en moderne nettleser for å vises korrekt. For å kunne chate med boten , må du ha en OpenAi nøkkel.
...
Applikasjonen må serves for å fungere.
